...
When you provide a replacement credential, NemoClaw validates it before it backs up workspace state, destroys the sandbox, recreates it, and restores the backup.
